...
\begin{itemize}
   ...
   \item General comment. I would explicity add/state that $x$ denotes counts whereas ${\bf x}$ locations. Sometimes also ${\bf x}$ and  $\textit{\textbf{x}}$ are used interchangeably (page 9 in log-probability density and page 10 in itensity function).
\end{itemize}
\end{document}