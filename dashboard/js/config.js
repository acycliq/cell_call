...
function config(){
    var ini = [
        ...
        {name: 'default_42genes', roi: {x0: 6150, x1: 13751, y0: 12987, y1: 18457}, imageSize: [16384, 11791], cellData: './dashboard/data/img/default_42genes/json/iss.json', geneData: './dashboard/data/img/default_42genes/csv/Dapi_overlays.csv', tiles: './dashboard/data/img/default/16384px/{z}/{x}/{y}.png'}, // 1
