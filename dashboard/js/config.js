...
function config(){
    var ini = [
        ...
        {name: 'Simulated spots (98 gene panel inc fakes)', roi: {x0: 6150, x1: 13751, y0: 12987, y1: 18457}, imageSize: [16384, 11791], cellData: './dashboard/data/img/sim_123456_98genes _fakeGenesOutside/json/iss.json' , geneData: './dashboard/data/img/sim_123456_98genes _fakeGenesOutside/csv/Dapi_overlays.csv' , tiles: './dashboard/data/img/default_98genes/16384px/{z}/{x}/{y}.png'} ,  // 4
